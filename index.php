	...
	<center>
		<div id="all">	
			<div id="login">
				...
				<form method="post" action="runners/login.php" autocomplete="off">
		...
		<section class="nsromapa">
			 <p class="about-author">
				...
				&copy; <?php echo "$copyright"; ?> <a href="mailto://saytoonz05@gmail.com" target="_blank">Our Supermarket's System</a> -
