...
$differentiator=$get['differentiator'];
      ...
      $this->Cell(300,10,'ALL INVENTORIES AND SALES OF '.mb_strtoupper($differentiator).' '.mb_strtoupper($itemName).' ',0,1,'C');
...
$tSALES_AMT="";
$tTOTAL_AMT="";
$query=mysql_query("SELECT * FROM salesandsupplies WHERE itemID='$grabO' AND active='yes' ORDER BY invent_Date ASC");
