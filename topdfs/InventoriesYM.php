...
$differentiator=$get['differentiator'];
      ...
      $this->Cell(300,10,$monthInWrds.' '.$Year.' INVENTORIES OF  '.mb_strtoupper($differentiator).' '.mb_strtoupper($itemName).' ',0,1,'C');
      $this->Ln(5);
...
$tQuantity="";
$query=mysql_query("SELECT * FROM inventories WHERE itemName='$itemName' AND itemDifferentiator='$differentiator' AND year='$Year' AND month='$Month' AND active='yes'  ORDER BY invent_Date ASC");
