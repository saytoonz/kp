...
$differentiator=$get['differentiator'];
      ...
      $this->Cell(300,10,'All Sales/Supplies Of  '.mb_strtoupper($differentiator).' '.mb_strtoupper($itemName).' ',0,1,'C');
      $this->Ln(5);
...
$tSALES_AMT="";
$tTOTAL_AMT="";
$query=mysql_query("SELECT * FROM salesandsupplies WHERE itemID='$grabO' AND active='yes' AND WAY_BILL='' AND QTY='' AND COST_PRICE=''ORDER BY invent_Date ASC");
