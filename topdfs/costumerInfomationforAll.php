...
$this->Cell(20,10,'DEPT',1,0,'C',true);
...
while ($data=mysql_fetch_array($query)) {
  ...
  $pdf->Cell(45,10,$data['Customername'],1,0);
  $pdf->Cell(50,10,$data['Companyname'],1,0);
  $pdf->Cell(25,10,$data['mobile'],1,0,'C');
  $pdf->Cell(25,10,$data['tel'],1,0,'C');
  $pdf->Cell(50,10,$data['address'],1,0,'C');
  $pdf->Cell(25,10,$data['Folio'],1,0,'C');
  $pdf->Cell(20,10,$DEBIT,1,0,'C');
  $pdf->Cell(20,10,$active,1,1,'C');
}
